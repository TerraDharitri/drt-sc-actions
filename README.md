...
When using the action, pay attention to the branch naming under the push event and use either `main` or `main` accordingly. Using the wrong main branch name will cause the github actions build to be skipped, without displaying an error message.
...
Sets up the build environment with Rust, sc-meta, drt-go-scenario, and other required tools. Creates artifacts that can be used by subsequent jobs.

**Usage:**
```yaml
jobs:
  setup:
    uses: TerraDharitri/drt-sc-actions/.github/workflows/setup.yml@vMajor.Minor.Patch
    with:
      ...
      drt-go-scenario-version: ""  # optional, default: latest
...
jobs:
  build-contracts:
    ...
    uses: TerraDharitri/drt-sc-actions/.github/workflows/build-contracts.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
      rust-target: "wasm32-unknown-unknown"  # optional, default: "wasm32-unknown-unknown"
...
Runs WASM tests using drt-go-scenario.
...
jobs:
  wasm-tests:
    ...
    uses: TerraDharitri/drt-sc-actions/.github/workflows/wasm-tests.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
```
...
jobs:
  interactor-tests:
    needs: build-contracts  # Requires build-contracts job to run first
    uses: TerraDharitri/drt-sc-actions/.github/workflows/interactor-tests.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
```
...
jobs:
  test-coverage:
    needs: setup  # Requires setup job to run first
    uses: TerraDharitri/drt-sc-actions/.github/workflows/coverage.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
      rust-target: "wasm32-unknown-unknown"  # optional, default: "wasm32-unknown-unknown"
...
jobs:
  rust-tests:
    uses: TerraDharitri/drt-sc-actions/.github/workflows/rust-tests.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
```
...
jobs:
  generate-report:
    needs: build-contracts  # Requires build-contracts job to run first
    uses: TerraDharitri/drt-sc-actions/.github/workflows/report.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
```
...
jobs:
  proxy-compare:
    needs: setup  # Requires setup job to run first
    uses: TerraDharitri/drt-sc-actions/.github/workflows/proxy-compare.yml@vMajor.Minor.Patch
    with:
      rust-toolchain: "stable"  # optional, default: "stable"
      runs-on: "ubuntu-latest"  # optional, default: "ubuntu-latest"
```
...
- `wasm-tests.yml` - needs sc-meta and drt-go-scenario artifacts
